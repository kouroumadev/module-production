                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row"><input type="file" class="form-control-file form-control height-auto"  onchange="myFunction()" id="file1" /></th>
                                            <th scope="row" id="file1_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">2</th>
                                            ...
                                            <th scope="row" id="file2_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">3</th>
                                            ...
                                            <th scope="row" id="file3_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">4</th>
                                            ...
                                            <th scope="row" id="file4_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">5</th>
                                            ...
                                            <th scope="row" id="file5_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">6</th>
                                            ...
                                            <th scope="row" id="file6_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">7</th>
                                            ...
                                            <th scope="row" id="file7_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">8</th>
                                            ...
                                            <th scope="row" id="file8_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">9</th>
                                            ...
                                            <th scope="row" id="file9_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">10</th>
                                            ...
                                            {{-- <th scope="row" id="file10_staut"><span class="bg-success p-2 rounded text-white"><i class="icon-copy fa fa-thumbs-up" aria-hidden="true"></i> Chargé</span></th> --}}
                                            <th scope="row" id="file10_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">11</th>
                                            <th scope="row">La copie legalisee de l'extrait de mariage de chaque veuve</th>
                                            <th scope="row"><input type="file" id="file11" class="form-control-file form-control height-auto" onchange="myFunction()"></th>
                                            <th scope="row" id="file11_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">12</th>
                                            <th scope="row">La copie legalisee de l'extrait de naissance de chaque enfant de moins de 17 ans</th>
                                            <th scope="row"><input type="file" id="file12" class="form-control-file form-control height-auto" onchange="myFunction()"></th>
                                            <th scope="row" id="file12_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">13</th>
                                            <th scope="row">Certificat de vie collective individuelle des enfants de moins de 17 ans</th>
                                            <th scope="row"><input type="file" id="file13" class="form-control-file form-control height-auto" onchange="myFunction()"></th>
                                            <th scope="row" id="file13_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        <tr>
                                            <th scope="row">14</th>
                                            <th scope="row">Numero de telephone de l'assure</th>
                                            <th scope="row"><input type="file" id="file14" class="form-control-file form-control height-auto" onchange="myFunction()"></th>
                                            <th scope="row" id="file14_staut"><span class="badge badge-danger"><i class="icon-copy fa fa-warning" aria-hidden="true"></i> Non Chargé</span></th>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
