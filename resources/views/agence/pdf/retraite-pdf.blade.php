                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="3" style="width:100%;text-align:center;font-weight:bold;font-size:14px">
                            @if ($type == '01-')
                            ETAT DE PAYEMENT DES PENSIONS DE RETRAITE {{ $ville }}
                            @else
                            ETAT DE PAYEMENT DES PENSIONS D'INVALIDITE {{ $ville }}
                            @endif
                        </td>
                    </tr>
                    <tr>
        ...
        <div>
            <table class="detail" style="width:100%; border-collapse: collapse;font-size: 12px">
                ...
                <tbody>
                    ...
                    <tr style="">
                        <td colspan="8" style="width:100%;height: 100px;border: 1px solid white"></td>
                        <td colspan="8" style="width:100%;height: 100px;border: 1px solid white"><p style="float:right;">Conakry, le {{ $date }}</p></td>
                    </tr>
                    <tr style="">
