        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    ...
                    <span class="user-name">Ross C. karim</span>
                </a>
    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="{{ route('pension.index') }}" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-diagram"></span><span class="mtext">Pensionnaire</span>
                    </a>
                </li>
